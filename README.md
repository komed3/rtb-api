...
If you intend to use this data offline, please note that the API consists of over 50,000 individual files in more than 4,500 directories and that the total size of the unpacked files is around two gigabytes.
